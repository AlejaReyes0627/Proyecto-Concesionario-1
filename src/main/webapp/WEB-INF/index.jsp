            ...
            <div class="card border-secondary mb-3">
              ...
              <div class="card-body">
                <form >
                  ...
                  <br>
                  <div class="btn-group" style="padding-right: 1cm">
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary" name="act" value="eliminar"  style="padding-right: 1cm;padding-left: 1cm;transform: translateX(10%);">
                      Eliminar propietario
                    </button>
                    <br>
                    <button type="submit" class="btn btn-primary" name="act" value="actualizar"  style="padding-right: 1cm;padding-left: 1cm;transform: translateX(15%);">
